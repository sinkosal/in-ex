...
error_reporting(E_ALL ^ E_DEPRECATED ^ E_NOTICE);
  ...
  define('HTTP_COOKIE_PATH', '/IMI/');
  define('HTTPS_COOKIE_PATH', '/IMI/');
  define('DIR_WS_HTTP_CATALOG', '/IMI/');
  define('DIR_WS_HTTPS_CATALOG', '/IMI/');
  ...
  define('DIR_FS_CATALOG', '/var/www/IMI/');
